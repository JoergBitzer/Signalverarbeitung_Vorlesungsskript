...
def quantize_midrise (x, bits):
    '''
    quantizes the input samples with a certain bit depth 
...
ax_sin1.set(xlabel='Zeit in s', ylabel='Amplitude', 
        title='Nur Quantisierung (4 Stufen), Sinus = 100 Hz', 
...
ax_sin2.set(xlabel='Zeit in s', ylabel='Amplitude', 
        title='Abtastung (fs = 2000 Hz) + Quantisierung, Sinus = 100 Hz', 
        xlim=[0, 0.02], ylim=[-1, 1])
