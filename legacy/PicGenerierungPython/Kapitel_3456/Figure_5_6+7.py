...
ax_spectrum.set(xlabel='Frequenz rad/pi ', 
...
ax_spec_stem.set(xlabel='Frequenz rad/pi ', 
        ylabel='Frequenzanteil normiert auf 1',
        title='Spektrum eines Rechteckfenster (Dirichlet-Funktion)')

ax_ifft.plot(ifft)
ax_ifft.set(xlabel='Folgenndex k ->', ylabel='Amplitude x[k]', 
        title='durch inverse FFT rekonstruiertes Signal')
