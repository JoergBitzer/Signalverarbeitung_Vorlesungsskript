...
ax_si.set(xlabel='Folgenkindex k ->', ylabel='Amplitude x(k)', title='SI-Funktion')
...
ax_spec.plot(w_short, 20 * numpy.log10(abs(spectrum_short)), linestyle='dotted')
ax_spec.plot(w, 20 * numpy.log10(abs(spectrum)))
ax_spec.set(xlabel='Frequenz normalisiert mit w/pi', ylabel='Amplitude in dB', title='Spektrum', xlim=([0, 0.4]))
#ax_spec.set_xlim([])
#ax_spec.margins(0, 0.05)
